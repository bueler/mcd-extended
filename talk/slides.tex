...
\begin{frame}{multigrid strategies for nonlinear VIs: feature table}
...
{\color{FireBrick} FASCD}  & $\checkmark$ & {\color{FireBrick} \textbf{?}} & $\checkmark$ & {\color{FireBrick} {\large $\checkmark$}}
\end{tabular}
}
