...
for all FIXME
\end{assumptions}
Note that the constants $C_1,C_2$ generally depend on $m$.  % IF PROOF BELOW SUCCEEDS, SO ALGORITHM IS NORM DECREASING, THEN MAY BE ABLE TO ARGUE THAT IT IS O.K. FOR CONSTANTS TO DEPEND ON $u,v,w_{ij}$ etc. AS LONG AS THEY ARE UNIFORMLY BOUNDED ON CERTAIN BOUNDED SETS
