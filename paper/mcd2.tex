...
\begin{pcode}[ht]
\begin{pseudo*}
\pr{cd-parallel}(f:\cK \to \cV', g\in \cV', \{\cK_i\}, \{R_i:\cK \to \cK_i\}, 0<\alpha\le 1, u\in\cK)\text{:} \\+
...
\begin{pcode}[ht]
\begin{pseudo*}
\pr{cd-sequential}(f:\cK \to \cV', g\in \cV', \{\cK_i\}, \{R_i:\cK \to \cK_i\}, 0<\alpha\le 1, u\in\cK)\text{:} \\+
