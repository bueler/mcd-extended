...
FIXME  It is hard to say which aspect of FAScd is more important to beating monotone multigrid: stronger smoother or improved up-smooth CD.  Probably the former, but for now we don't have any illuminating analysis, and a head-to-head race is comparing apples and oranges because we are using such a strong smoother.  Various differences of implementation don't produce any really good multigrid convergence if your smoother is NGS on each level.  I think the convergence proofs in \cite{GraeserKornhuber2009} all depend on this?
