...
Firedrake applications can exploit the PETSc \cite{Balayetal2023} library's parallel solvers.  The above Examples, which were run in serial, also run efficiently in parallel.  The next two Examples apply parallel solvers and investigate the weak scaling of FMG.
