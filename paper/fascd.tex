...
FIXME show results for Firedrake implementation of FASCD for the 2D classical obstacle problem (ball and spiral; Example \ref{ex:plaplacian}), 1D $p$-Laplacian obstacle problem (also Example \ref{ex:plaplacian}), advection-diffusion obstacle problem (Example \ref{ex:advectiondiffusion}), and SIA obstacle problem (Example \ref{ex:sia})
