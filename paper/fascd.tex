...
%\pef{unlike \cite{GraeserKornhuber2009}?}
% Hard to say.  They only look at one resolution, and they don't show something like "ball".  But their iterations are in the 40--80 range; I've noted that.
...
%\pef{Write down the exact solution?}
% see code reproducibility
...
%\pef{I would have said you need $Pe < 1$ to be diffusion-dominated, not have $Pe = 40$?}
% Clarified that this is a mesh Peclet thing.
