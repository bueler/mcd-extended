...
\begin{tikzpicture}[scale=0.85]
  ...
  \filldraw[seabornblue] (2.0, 0.5) circle (2.5pt);
  \node at (3.7, 0.5) {{\scriptsize coarse mesh node}};
  \filldraw[seaborngreen] (2.0, 0.0) circle (1.5pt);
  \node (fine) at (3.5, 0.0) {{\scriptsize fine mesh node}};
\end{tikzpicture}
