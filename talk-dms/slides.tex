...
\hfill
\only<1-2>{\includegraphics[width=0.2\textwidth]{../paper/fixfigs/ball-set.png} \hspace{1mm}}
\only<3>{\includegraphics[width=0.2\textwidth]{../paper/fixfigs/spiral-set.png} \hspace{2mm}}

\bigskip

\begin{center}
%\only<1>{\includegraphics[width=0.25\textwidth]{figs/balliterslog.png}}
\only<1>{\includegraphics[width=0.5\textwidth]{figs/balliters.png}}
\only<2>{\includegraphics[width=0.5\textwidth]{figs/balliters.png}}
\only<3>{\includegraphics[width=0.5\textwidth]{figs/bothiters.png}}
\end{center}
